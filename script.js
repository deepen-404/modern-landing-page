...
elements.forEach((element) => {
  ...
  document.querySelector("#main").addEventListener("click", function () {
    if (!animating) {
      animating = true;
      // moving the selected h1 out of the screen
      gsap.to(h1s[index], {
        top: "-=100%",
        ease: Expo.easeInOut,
        duration: 1,
      ...
      // making another h1 to come into the view
      gsap.to(h1s[index], {
        top: "-=100%",
        ease: Expo.easeInOut,
        duration: 1,
